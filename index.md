## Short Biography
[Kabul Kurniawan](https://kabulkurniawan.github.io) is an Assistant Professor at the [Department of Computer Science and Electronics](https://dcse.fmipa.ugm.ac.id), [Universitas Gadjah Mada (UGM)](https://ugm.ac.id), Indonesia. He holds a Ph.D. in Computer Science from the [University of Vienna](https://www.univie.ac.at) (2023) and a B.Sc and M.Sc in Computer Science from UGM (2013, 2015). Before returning to UGM, he worked as a Post-Doctoral Researcher and Research Engineer at [Vienna University of Economics and Business](https://www.wu.ac.at) and the [Center for Digital Production (CDP) Austria](https://acdp.at), following earlier research roles at [TU Wien](https://www.tuwien.at). His research focuses on **Knowledge Graphs**, **Decentralized Web**, **Information Security**, **Privacy**, and **NeuroSymbolic AI**, with work published in top-tier venues (Computers & Security, MAKE) and presented at leading conferences including ESWC, ISWC, SEMANTiCS, ARES, and IFIP SEC.
